...
export const metadata: Metadata = {
  ...
  description: 'Descarga videos y audio de YouTube, TikTok, Twitter, Instagram, Vimeo y mas de 1000 sitios. Gratis, sin registro.',
};
...
export default function DescargarVideoPage() {
  ...
  const steps = [
    'Copia la URL del video desde YouTube, TikTok, Instagram o cualquier sitio compatible',
    'Pega la URL en el campo de arriba',
    'Elige Video (MP4) o Audio (MP3)',
    'Haz clic en Descargar y espera unos segundos',
    'Descarga tu archivo',
  ];
  const faqItems = [
    { q: 'Que sitios son compatibles?', a: 'YouTube, TikTok, Twitter/X, Instagram, Vimeo, Dailymotion, Facebook, Reddit y mas de 1000 sitios.' },
    { q: 'Que calidad tiene el video?', a: 'Los videos se descargan en MP4 hasta 480p para un procesamiento rapido.' },
    { q: 'Puedo descargar solo el audio?', a: 'Si. Selecciona Audio (MP3) para extraer solo la pista de audio.' },
    { q: 'Es gratis?', a: 'Si, completamente gratis sin necesidad de cuenta.' },
    { q: 'Cuanto tiempo se guardan los archivos?', a: 'Los archivos se eliminan automaticamente despues de 2 horas.' },
  ];
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-white/60 max-w-2xl mx-auto">Descarga videos o audio de YouTube, TikTok, Twitter/X, Instagram, Vimeo, Facebook y mas de 1000 sitios. Gratis, sin registro.</p>
      </div>
      <div className="glass-card rounded-3xl p-7 sm:p-10 mb-14">
        <UrlDownloader locale={locale} />
      </div>
      <section className="mb-14">
        <h2 className="text-2xl font-bold text-white mb-6">Como descargar un video</h2>
